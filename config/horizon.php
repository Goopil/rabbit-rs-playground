...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | goopil/laravel-redis-sentinel activates its Horizon-aware queue
    | connector and redis bindings when this is set to "phpredis-sentinel".
    | Laravel Horizon itself ignores this key.
    |
    */

    'driver' => env('HORIZON_DRIVER', 'phpredis-sentinel'),
